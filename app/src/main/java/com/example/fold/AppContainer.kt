...
object AppContainer {
    ...
    fun getTxtReader(): TxtReader = _txtReader ?: TxtReader().also { _txtReader = it }
    fun getEpubReader(): EpubReader = _epubReader ?: EpubReader().also { _epubReader = it }
    fun getPdfReader(): PdfReader = _pdfReader ?: PdfReader().also { _pdfReader = it }
